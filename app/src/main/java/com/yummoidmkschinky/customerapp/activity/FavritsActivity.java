...
public class FavritsActivity extends AppCompatActivity implements GetResult.MyListener, RestaurantsAdp.RecyclerTouchListener {
    ...
    private void getRetorantList() {
        ...
        Call<JsonObject> call = APIClient.getInterface().getFavrits(bodyRequest);
